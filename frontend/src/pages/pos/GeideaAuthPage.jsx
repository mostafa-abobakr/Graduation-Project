        ...
        <div className="min-h-[100vh] p-4 flex items-center justify-center ">
            <div className="w-full max-w-md text-center">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-semibold mt-2">Geidea</h1>
                </div>

                <div className=" border-2  rounded-xl shadow-md p-6 text-left">
                    <h2 className="text-lg font-semibold mb-2">Authorize Application</h2>
                    <p className="text-sm text-gray-600 mb-4">Merchant Partner App would like to access your Geidea account</p>
                    <p className="text-sm font-medium mb-3">This application will be able to:</p>
                    ...
                    <div className="space-y-3 mb-4">
                        <form onSubmit={(e) => e.preventDefault()}>
                            ...
                            {ErrorMap && <p className="text-sm font-medium text-destructive mt-1">{ErrorMap}</p>}
                    ...
                    <p className="text-xs text-gray-400 mt-4 text-center">
                        By authorizing this application, you agree to share the information listed above. You can revoke access at any time from your Geidea account settings.
                    </p>
                </div>
