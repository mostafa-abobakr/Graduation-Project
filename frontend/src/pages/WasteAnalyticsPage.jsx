    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card className="p-5 bg-card border-border/60 premium-shadow">
          ...
          <div className="stat-number text-foreground">{totalWaste} kg</div>
        </Card>
        <Card className="p-5 bg-card border-border/60 premium-shadow">
          <div className="text-sm text-muted-foreground mb-2">Waste Cost</div>
          <div className="stat-number text-foreground">
            ${wasteByItem.reduce((s, i) => s + i.cost, 0).toFixed(0)}
          </div>
        </Card>
        <Card className="p-5 bg-card border-border/60 premium-shadow">
          <div className="text-sm text-muted-foreground mb-2">
