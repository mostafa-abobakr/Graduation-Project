...
export default function AIInsightsPage() {
  ...
  const surgePercent =
    periodData
      ? Math.round(
          ((periodData.total_predicted_revenue - periodData.total_actual_revenue) /
            periodData.total_actual_revenue) *
            100
        )
      : null;
