  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/request_swap': (context) {
          final shift = ModalRoute.of(context)?.settings.arguments as ShiftSchedule?;
          return RequestSwapScreen(shift: shift);
        },
        '/request_time_off': (context) {
          final shift = ModalRoute.of(context)?.settings.arguments as ShiftSchedule?;
          return RequestTimeOffScreen(shift: shift);
        },
